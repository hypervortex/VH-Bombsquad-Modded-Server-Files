...
class BombFactory:
    ...
    def __init__(self) -> None:
        ...
        self.regular_tex = ba.gettexture('landMine')
        self.ice_tex = ba.gettexture('powerupShield')
        self.sticky_tex = ba.gettexture('aliColorMask')
        self.impact_tex = ba.gettexture('white')
        self.impact_lit_tex = ba.gettexture('pixieColor')
        self.land_mine_tex = ba.gettexture('ouyaOButton')
        self.land_mine_lit_tex = ba.gettexture('white')
        self.tnt_tex = ba.gettexture('achievementTNT')
