...
class BombFactory:
    ...
    def __init__(self) -> None:
        ...
        self.tnt_model = ba.getmodel('bomb')

        self.regular_tex = ba.gettexture('ouyaUButton')
        self.ice_tex = ba.gettexture('egg2')
        self.sticky_tex = ba.gettexture('ticketRolls')
        self.impact_tex = ba.gettexture('fuse')
        self.impact_lit_tex = ba.gettexture('impactBombColorLit')
        self.land_mine_tex = ba.gettexture('analogStick')
        self.land_mine_lit_tex = ba.gettexture('white')
        self.tnt_tex = ba.gettexture('ouyaOButton')
