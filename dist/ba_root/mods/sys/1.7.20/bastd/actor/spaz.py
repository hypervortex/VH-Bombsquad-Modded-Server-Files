    ...
    def handlemessage(self, msg: Any) -> Any:
        ...
        if isinstance(msg, ba.PickedUpMessage):
            ...
            if msg.hit_type == 'punch':
                ...
                if damage > 1120:
                    PopupText(u"\ue043K.\ue046.O\ue043",color=(3,0,0),scale=2.0,position=self.node.position).autoretain()
                    ba.emitfx(position=(self.node.position[0],self.node.position[1]+4,self.node.position[2]),velocity=(0,0,0),scale=1.5,count=400,spread=0.6,chunk_type='metal')
                    def light():
                    ...
                    def dark(val):
                        if val == 1:
                            ...
                            activity.globalsnode.tint = (0.1, 0.1, 0.1)
                        else:
                    ...
                    ba.Timer(300, ba.Call(dark,2))										        								        

                elif damage > 80 and damage < 100:
                    PopupText(u"\ue049GRAND MASTER\ue049",color=(0.3,1,0),scale=1.8,position=self.node.position).autoretain()
                    ba.emitfx(position=(self.node.position[0],self.node.position[1]+4,self.node.position[2]),velocity=(0,0,0),scale=1.5,count=300,spread=0.7,chunk_type='metal')
                    
                elif damage > 60 and damage < 80:
                    PopupText(u"\ue048AWESOME!!\ue048",color=(0,1,3),scale=1.8,position=self.node.position).autoretain()
                    ba.emitfx(position=(self.node.position[0],self.node.position[1]+4,self.node.position[2]),velocity=(0,0,0),scale=1.5,count=200,spread=0.7,chunk_type='metal')
                    
                elif damage > 40 and damage < 60:
                    PopupText(u"\ue042COOL\ue042",color=(0,0,1),scale=1.8,position=self.node.position).autoretain()
                    ba.emitfx(position=(self.node.position[0],self.node.position[1]+4,self.node.position[2]),velocity=(0,0,0),scale=1.5,count=100,spread=0.7,chunk_type='metal')
	                	        
                    
                elif damage > 20 and damage < 40:
                    PopupText(u"\ue04fGOOD!\ue04f",color=(2,2,0),scale=1.8,position=self.node.position).autoretain()
                    ba.emitfx(position=(self.node.position[0],self.node.position[1]+4,self.node.position[2]),velocity=(0,0,0),scale=1.5,count=50,spread=0.7,chunk_type='metal')
				       								        
                    
                elif damage > 0 and damage < 20:
                    PopupText(u"BAD PUNCH",color=(1,0.5,0),scale=1.8,position=self.node.position).autoretain()
