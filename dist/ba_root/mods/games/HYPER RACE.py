...
import ba
from ba import _map
from bastd.actor.bomb import Bomb, Blast, BombFactory
...
class TNT(ba.Actor):
    ...
    def __init__(self,
        ...
        self._collide_material = ba.Material()
...
class RaceGame(ba.TeamGameActivity[Player, Team]):
    ...
    def __init__(self, settings: dict):
        ...
        self._safe_region_material = ba.Material()
    ...
    def _obstacles(self) -> None:
        ...
        ba.timer(0.1, ba.WeakCall(self._tnt, (-3.2, 5, 1),
            (0, 0, 0), 1.0, (0, 20, 60)), repeat=True)

        ba.timer(1.6, ba.WeakCall(self._bomb, 'impact',
        ...
        ba.timer(1.6, ba.WeakCall(self._bomb, 'sticky',
